// forked from design-sync lib/source-kit.mjs - shadcn-style ui/ dir: one file exports many
// compound parts (dialog.tsx -> Dialog, DialogHeader, ...), so the name-based
// fuzzy-find misses most of them and everything lands in one "general" group.
// This fork maps each export to the file that declares it and groups files by
// the categories in UI_CATEGORY below.
